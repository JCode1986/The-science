    ...
    return (
        <div className="bg-statisticsBgColor pb-20">
            <div className="ml-28 mr-28">
                    ...
                    <div className="pr-4 mr-4"style={{border:"1px solid grey"}}>
                        <span>
                            ...
                            <p className="pl-3 pb-2">
                                Xu J, Shi J, Cui X, Li JJ, Goel A, Chen X, Issa <br/> JP, Su J, Li W.
                            </p>
                            <p className="pl-3 pb-5 text-learnMoreColor font-bold">
                                Nature, March 2019
                            </p>
                        </span>
                    </div>
                ...
                <button className="font-bold py-2 px-4 text-darkgrey mt-7"
